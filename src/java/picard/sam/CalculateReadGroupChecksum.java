...
public class CalculateReadGroupChecksum extends CommandLineProgram {
    ...
    static final String USAGE_DETAILS = "This tool creates a hash code based on identifying information in the read group " +
            "(RG) of a \".BAM\" or \"SAM\" file header.  Addition or removal of RGs changes the hash code, enabling the user to " +
            "quickly determine if RG changes have been made. " +
            "<br />" +
            "<h4>Usage example:</h4>" +
            "<pre>" +
